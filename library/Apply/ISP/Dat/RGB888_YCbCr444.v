...
reg	[2:0]	per_frame_vsync_d;
reg	[2:0]	per_frame_href_d;	
always@(posedge clock or posedge reset) begin
	if(reset) begin
		per_frame_vsync_d <= 0;
		per_frame_href_d <= 0;
		...
		per_frame_vsync_d 	<= 	{per_frame_vsync_d[1:0], 	per_img_vsync};
		per_frame_href_d 	<= 	{per_frame_href_d[1:0], 	per_img_href};
	end
end
assign	post_img_vsync 	= 	per_frame_vsync_d[2];
assign	post_img_href 	= 	per_frame_href_d[2];
