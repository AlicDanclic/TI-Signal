...
TASK5_CV_BUILD = "2026-08-02-lowfreq-r19-hifreq-r22-r23"
TASK5_CV_BUILD_TAG = "CV-R23"
...
class AutoLissajousController:
    ...
    def _finish_circle_sweep_candidate(self, now: float) -> None:
        ...
        quick_target_seed = (
            ...
            target_fit_is_quick_locked(phase_fit, self._target, self.config)
        )
        LOGGER.info(
        ...
        if quick_target_seed:
            ...
            self._circle_hold_result = result
            LOGGER.info(
                "R21 quick target seed accepted target=%d %.3fkHz "
        ...
        quick_shape_locked = (
            (circle_fit_is_quick_locked(
             ...
             (target_fit_is_quick_locked(
                 phase_fit, self._target, self.config)
              if self._target != TARGET_CIRCLE and phase_fit is not None else
              False))
        )
    ...
    def _capture_track_frame(self, now: float) -> None:
        ...
        quick_locked = target_fit_is_quick_locked(
            analysis, self._target, self.config)
            ...
            'lock_quality': 65,
             ...
             'trace_extraction': {'calibration_frame_size': [640, 480],
              ...
              'tracking_lock': {'lock_quality': 72,
                               ...
                               'quick_lock_quality': 56,
                               'quick_lock_quality_by_target': {'1': 56, '3': 54},
                               'quick_lock_maximum_desired_score': 0.090,
                               'quick_lock_phase_deadband': 20,
                                'phase_deadband': 3,
                                'phase_proportional_gain': 1.0,
                                'phase_maximum_step': 96,
             ...
             'circle_sweep': {'step_hz': 100.0,
                              'tier_radii_hz': [400.0, 1000.0, 2000.0, 3000.0],
                              'high_frequency_threshold_hz': 25000.0,
             ...
             'circle_lock': {'screen_size': [640, 512],
                             ...
                             'fast_lock_maximum_axis_ratio': 1.65,
                             'fast_lock_maximum_span_delta_div': 1.10,
                             'quick_lock_enabled': False,
                             'quick_lock_quality': 54,
                             'quick_lock_maximum_axis_ratio': 2.20,
                             'quick_lock_maximum_center_error_div': 2.50,
                             'quick_lock_maximum_occupancy': 0.24,
                            ...
                            'lock_quality': 68,
                             'maximum_span_delta_div': 0.60,
                             'minimum_span_div': 6.0,
                            'maximum_span_div': 9.4,
                            'maximum_center_error_div': 1.3,
                             'maximum_radial_cv': 0.20,
                             'maximum_axis_ratio': 1.45,
                             'maximum_inner_fill_ratio': 0.32,
                             'maximum_fill_ratio': 0.35,
                            'minimum_angular_coverage': 0.55,
                             'correction_minimum_angular_coverage': 0.28,
                            'correction_maximum_radial_cv': 0.28,
                            'correction_maximum_inner_fill_ratio': 0.38,
                            'correction_maximum_fill_ratio': 0.65,
