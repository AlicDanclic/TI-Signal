...
#
# Script generated by Vivado on Tue Jul 14 20:32:59 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mizar_ps.sh
...
#
# Usage        : mizar_ps.sh
#                mizar_ps.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mizar_ps.sh [-reset_run]
#                mizar_ps.sh [-reset_log]
#                mizar_ps.sh [-help]
#
...
export RDI_DATADIR="E:/Vitis2/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xilinx_vip"

# script info
echo -e "mizar_ps.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mizar_ps.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mizar_ps xil_defaultlib.mizar_ps xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mizar_ps -key {Behavioral:sim_1:Functional:mizar_ps} -tclbatch cmd.tcl -protoinst "protoinst_files/mizar_ps.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Vitis2/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mizar_ps.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mizar_ps.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mizar_ps.sh [-help]\n\
Usage: mizar_ps.sh [-step]\n\
Usage: mizar_ps.sh [-lib_map_path]\n\
Usage: mizar_ps.sh [-reset_run]\n\
Usage: mizar_ps.sh [-reset_log]\n\
Usage: mizar_ps.sh [-keep_index]\n\
Usage: mizar_ps.sh [-noclean_files]\n\n\
